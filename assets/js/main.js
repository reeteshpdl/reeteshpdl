...
window.addEventListener("DOMContentLoaded", function () {
    ...
    function success(){
        ...
        status.innerHTML = "Your order is placed."
    }
    function error(){
